...
class ReservaSolicitada extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Pedido de reserva recebido na Amo Pet House')
            ->greeting('Olá, '.$notifiable->nome.'!')
            ->line('Recebemos seu pedido de reserva. A equipe confirma em breve.')
            ...
            ->line('O pagamento é feito no checkout presencial, depois que a reserva for confirmada.')
